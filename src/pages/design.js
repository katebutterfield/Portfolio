...
import Project from '../components/project'; // You can also use <link> for styles
// ..
...
const Design = () => (
  ...
  /></Link>
   ...
   <div><Link to="/employstream"><Project
