    ...
    <div class="description">
      <div class="hsad-list">
        <ul>
          ...
          <li><h4>PROBLEM</h4><p>High School AD Network has traditionally only been available as a web app. The tool's main purpose is to commicate with other AD's, which could occur at any point in the day. If a user doesn't have their desktop handy they won't get the best experience using the platform.</p></li>
          <li><h4>SOLUTION</h4><p>I proposed a mobile app design that would allow Athetic Directors to post information, schedule games, message other AD's, and sell equipment from their mobile device any time, anywhere.</p></li>
          <li><h4>PROCESS</h4><p>
